...
from PyQt5.QtWidgets import (QApplication, QWidget, QVBoxLayout, QHBoxLayout,
                             ...
                             QDialog, QTabWidget, QLineEdit, QMenu, QShortcut, QInputDialog)
...
class TransferWorker(QThread):
    ...
    def __init__(self, device_id, direction, transfers, action='copy'):
        super().__init__()
...
class FileManager(QMainWindow):
    ...
    def start_transfer(self, direction, transfers, action='copy'):
        ...
        self.worker = TransferWorker(self.device_id, direction, transfers, action)
    ...
    def do_transfer_btn(self, direction, action):
        if direction == 'push':
            ...
            if transfers:
                self.start_transfer('push', transfers, action)
            ...
            if transfers:
                self.start_transfer('pull', transfers, action)
...
class DeviceSelector(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle('ADB Device Selector V.2.0')
        self.resize(350, 400)
